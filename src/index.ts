...
program
  .command('get')
  .description('Display resources (agents, blocks, archives, tools, folders, files, mcp-servers)')
  .argument('<resource>', 'resource type (agents|blocks|archives|tools|folders|files|mcp-servers)')
